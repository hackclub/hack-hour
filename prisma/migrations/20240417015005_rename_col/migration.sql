/*
  ...
  - You are about to drop the column `defaultGoal` on the `User` table. All the data in the column will be lost.
  - Added the required column `selectedGoal` to the `User` table without a default value. This is not possible if the table is not empty.
