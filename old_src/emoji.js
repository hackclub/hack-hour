...
export function reactOnContent(app, data) {
    return __awaiter(this, void 0, void 0, function* () {
        Object.keys(emojis).forEach((keyword) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (data.content.toLowerCase().search(new RegExp("\\b" + keyword + "\\b", "gi")) !== -1) {
